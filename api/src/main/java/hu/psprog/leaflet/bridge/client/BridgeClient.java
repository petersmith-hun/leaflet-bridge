...
public interface BridgeClient {
     ...
     * @param responseType response type as {@link TypeReference} to map JSON answer to
     ...
     */
    <T> T call(RESTRequest request, TypeReference<T> responseType) throws CommunicationFailureException;
